...
beforeEach(() => {
  ...
  dbService = {
    connect: jest.fn().mockImplementation(() => new Promise((resolve: (value: unknown) => void) => resolve(null))),
    disconnect: jest.fn().mockImplementation(() => new Promise((resolve: (value: unknown) => void) => resolve(null))),
